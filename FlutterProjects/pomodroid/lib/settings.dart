...
class _SettingsState extends State<Settings> {
    ...
    return Container(
      child: GridView.count(
        ...
        children: <Widget>[
          ...
          Text(''),
          Text(''),
          SettingButton(Color(0xff455A64), '-', 10, -1, WORKTIME, updateSettings),
          TextField(
            style: textStyle,
          ...
          SettingButton(Color(0xff009688), '+', 10, 1, WORKTIME, updateSettings),
  ...
  readSettings() async{
    ...
    setState(() {
      ...
      txtWork.text = workTime.toString() == null ? '0' : workTime.toString();
      txtShort.text = shortBreak.toString() == null ? '0' : shortBreak.toString();
      txtLong.text = longBreak.toString() == null ? '0' : longBreak.toString();
